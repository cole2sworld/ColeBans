...
public final class MCBansBanHandler extends NoOpBanHandler {
	 ...
	 * this.api = api;
	 * mcb = new MCBans(api);
	 * System.out.println(GlobalConf.logPrefix +
	 * "[MCBansBanHandler] Verifying connection...");
	 * boolean valid = mcb.isValid();
	 * if (!valid) throw new IllegalArgumentException("API key not valid!");
	 * System.out.println(GlobalConf.logPrefix +
	 * "[MCBansBanHandler] API key & connection OK. Initalized.");
	 * }
	 * 
	 ...
	 * 
	 * @Override
	 * public void banPlayer(String player, String reason, String admin) throws
	 * PlayerAlreadyBannedException {
	 * if (isPlayerBanned(player, admin)) throw new
	 * PlayerAlreadyBannedException(player+" is already banned!");
	 ...
	 * 
	 * @Override
	 * public void tempBanPlayer(String player, long time, String admin) throws
	 * PlayerAlreadyBannedException, UnsupportedOperationException {
	 * if (isPlayerBanned(player, admin)) throw new
	 * PlayerAlreadyBannedException(player+" is already banned!");
	 * if (!GlobalConf.allowTempBans) throw new
	 * UnsupportedOperationException("Temp bans are disabled!");
	 * mcb.tempBan(player, time, admin);
	 * }
	 * 
	 * @Override
	 * public void unbanPlayer(String player, String admin) throws
	 * PlayerNotBannedException {
	 * if (!isPlayerBanned(player, admin)) throw new
	 * PlayerNotBannedException(player+" is not banned!");
	 * mcb.
	 * }
	 * 
	 * @Override
